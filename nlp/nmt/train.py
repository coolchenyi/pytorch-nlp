...
from nlp.nmt import onmt
from nlp.nmt.onmt.io.IO import load_fields_from_vocab, collect_features, OrderedIterator
...
from nlp.nmt.onmt.modules.CopyGenerator import CopyGeneratorLossCompute
...
def report_func(epoch, batch, num_batches,
    ...
    if batch % opt.report_every == -1 % opt.report_every:
        ...
        report_stats = Trainer.Statistics()
...
def train_model(model, fields, optim, data_type, model_opt):
    ...
    trainer = Trainer.Trainer(model, train_loss, valid_loss, optim,

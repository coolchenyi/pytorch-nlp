...
from nlp.nmt.onmt.io.IO import *
from nlp.nmt.onmt.io.TextDataset import *
...
def main():
    ...
    src_nfeats = get_num_features(opt.data_type, opt.train_src, 'src')
    tgt_nfeats = get_num_features(opt.data_type, opt.train_tgt, 'tgt')

...
from nlp.nmt.onmt.Models import EncoderBase
from nlp.nmt.onmt.Models import DecoderState
...
class PositionwiseFeedForward(nn.Module):
    ...
    def __init__(self, size, hidden_size, dropout=0.1):
        ...
        self.w_2 = nlp.nmt.onmt.modules.BottleLinear(hidden_size, size)
        self.layer_norm = nlp.nmt.onmt.modules.BottleLayerNorm(size)
...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, size, dropout,
        ...
        self.self_attn = nlp.nmt.onmt.modules.MultiHeadedAttention(
...
class TransformerEncoder(EncoderBase):
    ...
    def __init__(self, num_layers, hidden_size,
        ...
        self.layer_norm = nlp.nmt.onmt.modules.BottleLayerNorm(hidden_size)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def __init__(self, size, dropout,
        ...
        self.self_attn = nlp.nmt.onmt.modules.MultiHeadedAttention(
                head_count, size, dropout=dropout)
        self.context_attn = nlp.nmt.onmt.modules.MultiHeadedAttention(
                head_count, size, dropout=dropout)
        self.feed_forward = PositionwiseFeedForward(size,
                                                    hidden_size,
                                                    dropout)
        self.layer_norm_1 = nlp.nmt.onmt.modules.BottleLayerNorm(size)
        self.layer_norm_2 = nlp.nmt.onmt.modules.BottleLayerNorm(size)
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, num_layers, hidden_size, attn_type,
        ...
        self._copy = False
        if copy_attn:
            self.copy_attn = nlp.nmt.onmt.modules.GlobalAttention(
